...
Simple mixture of experts with learned routing for multi-modal fusion.
...
# Create MoE fusion module
moe = MixtureOfExperts(text_dim=768, tab_dim=128, fusion_dim=256)
...
fused = moe(text_features, tab_features)
# Output: (32, 256)
```
...
class MixtureOfExperts(nn.Module):
    """
    Simple 2-expert mixture of experts with learned routing.
    ...
    def __repr__(self) -> str:
        return (
            f"MixtureOfExperts(text_dim={self.text_dim}, "
